...
app.get(
    ...
    async function (
        ...
        try {
            ...
            if (
                !matchData ||
                !matchData.userIds.includes(userId)
            ) {
                return res.status(403).json({
            ...
            // Use the stable IceChat user id as the LiveKit identity.
            // This prevents the same browser session from getting a
            // different LiveKit identity on reconnects.
